...
type FakeAggregatedTripsRepository struct {
	...
	GetAllStub        func(context.Context) ([]internal.AggregatedTrips, error)
...
func (fake *FakeAggregatedTripsRepository) GetAll(arg1 context.Context) ([]internal.AggregatedTrips, error) {
...
func (fake *FakeAggregatedTripsRepository) GetAllCalls(stub func(context.Context) ([]internal.AggregatedTrips, error)) {
	fake.getAllMutex.Lock()
	defer fake.getAllMutex.Unlock()
	fake.GetAllStub = stub
}

func (fake *FakeAggregatedTripsRepository) GetAllArgsForCall(i int) context.Context {
	fake.getAllMutex.RLock()
	defer fake.getAllMutex.RUnlock()
