...
func TestAddTrafficIncidents(t *testing.T) {
	...
	msg.PayloadReturns([]byte(`{"tiempo_hecho":1589279257759, "hecho_trans": 2, "placa": "ABC-123", "licencia": "C12345678", "distancia_viaje": "15-20", "tiempo_viaje": "100-200", "ubicacion": "38.0088261,23.10"}`))
